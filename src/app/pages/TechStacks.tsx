...
const resumedownload = () => {
  ...
  link.href = 'https://github.com/CodifyAT/Portfolio/blob/4da1f41c7789c5e7f3b877286cce81fa17fa0e5e/Atharva_Tiwari_resume.pdf'; 
...
const TechStacks = () => {
  return (
    <motion.div className='lg:mr-[200px] lg:ml-[200px] sm:ml-[20px] mt-[120px]  text-white'
  ...
  <div className='border-[1px] px-10 border-slate-500 lg:rounded-[10px] sm:rounded-none mr-10 lg:mr-10 sm:ml-0 sm:mr-0 p-4'>
    <h1 className='font-bold text-2xlmt-4 mb-6 lg:ml-[20px] sm:ml-0'>Stack</h1>
